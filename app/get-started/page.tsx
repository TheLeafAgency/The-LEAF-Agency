...
export default function GetStarted() {
  ...
  const isNYCZip = zipCode.length === 5 && nycZipCodes.has(zipCode);
  const showZipWarning = zipCode.length === 5 && !isNYCZip;
        ...
        >
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <label style={labelStyle}>
                Company ZIP Code {showZipWarning && <span style={{ color: "#D00000" }}>*</span>}
                <input
                  name="zipCode"
                  type="text"
                  inputMode="numeric"
                  ...
                  style={{ ...inputStyle, borderColor: showZipWarning ? "#D00000" : "#E5E7EB" }}
                  placeholder="10001"
                  aria-invalid={showZipWarning}
                />
                {showZipWarning && (
                  <span
                    style={{
                  ...
                  >
                    Unfortunately, we only offer our services in NYC as of this current moment. We&apos;re hoping to expand our business soon and offer more for others eventually!
                  </span>
                )}
              </label>
              ...
              <button
                ...
                style={{
                  width: "100%",
                  marginTop: "10px",
                  opacity: isNYCZip ? 1 : 0.55,
                  cursor: isNYCZip ? "pointer" : "not-allowed",
                }}
              >
                Submit
              </button>
